...
\graph [random seed=10,spring layout,node distance=8.5cm]
{
				PUBLICACAO[entity] -- {
								...
								Subtitulo[attribute],
								pubTexto[as=Texto,attribute],
								Timestamp_obtencao[attribute],
				...
				COMENTARIO[entity] -- {
								ID[key attribute], Texto[attribute]
				},
				PESSOA[entity] -- {
								NomePessoa[as=Nome,attribute], AUTOR_URL[as=URL,key attribute], Imagem_perfil[attribute]
				},
				PUBLICACAO --[total,edge label=1,pos=0.95] "ESTA_EM"[relationship] --[edge label=N,pos=0.05] PORTAL,
				PUBLICACAO --[edge label=N,pos=0.95] "ESCRITA_POR"[relationship] --[edge label=N,pos=0.05] AUTOR,
